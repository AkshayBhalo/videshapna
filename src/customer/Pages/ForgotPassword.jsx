...
export default function ForgotPassword() {
  return (
    <>
     <Helmet>
        <title>Forgot password - Videsh Apna</title>
      </Helmet>
      <div
        className="relative isolate flex min-h-full  flex-1 flex-col justify-center px-6 py-12 lg:px-8 h-100vh"
      ...
      >
        ...
        <div className="box-log sm:mx-auto shadow-md sm:w-full md:max-w-md bg-sky-50">
          <div className="">
            <img
            ...
            <p className="text-gray-500 font-semibold text-sm mt-2 text-center">
