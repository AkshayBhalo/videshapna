...
const products = [
  {
    ...
    description: "Get a better understanding of your requirement",
...
export default function Navigation() {
  ...
  return (
    ...
    >
      <header className="bg-white" style={{ position: "relative" }}>
        <nav
          className="mx-auto flex max-w-9xl items-center  border-bottom justify-between p-6 lg:px-10"
          aria-label="Global"
        >
          ...
          <Popover.Group className="hidden lg:flex lg:gap-x-12">
            ...
            <Popover className="relative">
              <Popover.Button className="r-nav flex items-center gap-x-1 text-lg font-semibold leading-6 text-gray-900">
            ...
            <div className="hidden lg:ml-8 lg:flex pr-3">
              ...
              >
                ...
                <select
                  id="currency"
                  name="currency"
                  className="h-full rounded-md border-0 bg-transparent py-0 pl-2 pr-3 text-gray-500 :ring-2 sm:text-md font-semibold"
                >
                  focus
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6">
                  ...
                  <Disclosure as="div" className="-mx-3 fsdfsd">
                    {({ open }) => (
                      <>
